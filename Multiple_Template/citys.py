...
#Unicode error https://stackoverflow.com/questions/3224268/python-unicode-encode-error
...
def citys_run():
    ...
    place = remove_random_line('/home/lettuce/WorkCode/ChatGPTWordPRess/citys.txt')

    print(place)

    prompt = f"Generate a travel guild about {place}"
    title_prompt = f"Generate a travel guild title for {place} with no quote marks"
    ...
    prompt_1 = f"I have this travel article can you write an adtional section for the events/festivals at {prompt} write 300 words. This is what I have so far{article_block_content_1}"
    ...
    prompt_2 = f"I have this travel article can you write an adtional section for the location and food at {prompt} write 300 words. This is what I have so far{article_block_content_1}"
